...
import com.mka.fifa.world.cup2022.encyclopedia.presentation.matches.viewmodel.old.MatchesByGoalsViewModel

@Composable
fun MatchesByGoalsScreen(
    navController: NavController,
    viewModel: MatchesByGoalsViewModel = hiltViewModel()
) {

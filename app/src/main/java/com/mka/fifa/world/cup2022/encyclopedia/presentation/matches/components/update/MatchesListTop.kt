...
import com.mka.fifa.world.cup2022.encyclopedia.presentation.matches.components.old.MatchesDropdownCategory
...
fun MatchesListTop(
    ...
    LazyColumn(
        ...
        items(state.matches) { item: Updated_Matches ->
            MatchesListBody(matches = item, navController = navController)
        }
    }
